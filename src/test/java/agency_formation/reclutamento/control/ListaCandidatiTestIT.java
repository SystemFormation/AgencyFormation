...
public class ListaCandidatiTestIT {
    ...
    public static void init() throws SQLException {
        ...
        String query2 = "Insert into candidature (IdCandidatura,Curriculum,Stato,DataCandidatura,DataOraColloquio,IdCandidato,IdHR) " +
                "values(160,'test','NonRevisionata','2022-01-10','2022-01-20 17:30:00', 500,4);";
    ...
    @Test
    public void listaCandidatiPass() throws ServletException, IOException {
