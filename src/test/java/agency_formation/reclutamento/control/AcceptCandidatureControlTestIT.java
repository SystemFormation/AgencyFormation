...
public class AcceptCandidatureControlTestIT {
    ...
    public static void init() throws SQLException {
        ...
        //String query1 = "Insert into Utenti (IdUtente,Nome,Cognome,Pwd,Mail,Ruolo) values(10,'TestNome','TestCognome','lol','test2@gmail.com', 1)";
        // String query2= "Insert into candidature (IdCandidatura,Curriculum,DocumentiAggiuntivi,Stato,DataCandidatura,IdCandidato) values(10,'test','test','Accettata','2022-01-10', 10)";
    ...
    @Test //mi aspetto 2
    public void acceptCandidaturaFailIt() throws ServletException, IOException, ParseException, SQLException {
