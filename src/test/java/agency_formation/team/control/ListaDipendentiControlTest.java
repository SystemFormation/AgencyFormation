...
public class ListaDipendentiControlTest {
    ...
    @Test
    public void listaDipendentiSize0() throws IOException, ServletException {
        int idUser = 10;
    ...
    public void listaDipendentiPass() throws IOException, ServletException {
        ...
        Utente user = new Utente("Mario", "Rossi", "mario.rossi@gmail.com", "123", RuoliUtenti.TM);
        Dipendente dip = new Dipendente("Mario","Rossi","mario.rossi@gmail.com", "123", RuoliUtenti.TM,idUser,1999,"Fisciano","112", StatiDipendenti.DISPONIBILE);
