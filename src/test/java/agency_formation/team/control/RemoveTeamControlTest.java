...
public class RemoveTeamControlTest {
    ...
    public void userfail() throws IOException, ServletException {
        ...
        new RemoveTeamControl().doPost(request, response);
        writer.flush();
    ...
    @Test
    public void removeTeamIdDip0() throws ServletException, IOException {
        int idUser = 0;
        Utente user = new Utente("Mario", "Rossi", "mario.rossi@gmail.com", "123", RuoliUtenti.TM);
        user.setId(idUser);
        int idDip = user.getId();
        ...
        RemoveTeamControl servlet = Mockito.spy(RemoveTeamControl.class);

        Mockito.when(request.getSession()).thenReturn(session);
        Mockito.when(session.getAttribute("user")).thenReturn(user);
        Mockito.when(request.getParameter("idDip")).thenReturn(String.valueOf(idDip));
        Mockito.when(request.getServletContext()).thenReturn(context);
    ...
    @Test
    public void removeTeamIdDipPass() throws ServletException, IOException {
        int idUser = 10;
        Utente user = new Utente("Mario", "Rossi", "mario.rossi@gmail.com", "123", RuoliUtenti.TM);
        user.setId(idUser);
        int idDip = user.getId();
