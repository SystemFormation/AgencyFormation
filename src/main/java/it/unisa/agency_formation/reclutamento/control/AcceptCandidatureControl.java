...
public class AcceptCandidatureControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(acceptCandidature(candidatura.getIdCandidatura())) {
    ...
    public static boolean acceptCandidature(int idCandidatura) throws SQLException {
        ReclutamentoManager reclutamentoManager = new ReclutamentoManagerImpl();
        return reclutamentoManager.acceptCandidature(idCandidatura);
    }
}
