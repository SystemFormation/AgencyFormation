...
-- Dumping data for table af_db.dipendenti: ~1 rows (approximately)
...
-- Dumping data for table af_db.team: ~1 rows (approximately)
DELETE FROM `team`;
...
-- Dumping data for table af_db.utenti: ~4 rows (approximately)
DELETE FROM `utenti`;
